...
public class CContactoModificarPractica {
	@FXML
	private Button add;
    ...
    @FXML
    private void ModificarPracticas() throws SQLException {
    	conexionbbdd = new TestConexion();
    	try {
    		...
    		if (selectedEmpresa != null && selectedAlumno != null) {
    			conexionbbdd.ModificarPracticas(selectedEmpresa.num_convenio, selectedAlumno.dni_alum, Fecha_Inicio.getText(), Fecha_Terminacion.getText(), Fecha_Final.getText(), Dias_Semana.getText(), Tipo_Horario.getText(), Horas_al_dia.getText(), Total_horas.getText(), Hora_Inicio.getText(), Hora_terminacion.getText());
    		}else {
